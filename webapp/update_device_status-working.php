<?php
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['deviceId']) && isset($_POST['status'])) {
    ...
    $command = escapeshellcmd("python3 " . $pythonScriptPath . " " . escapeshellarg($deviceId) . " " . escapeshellarg($status));
