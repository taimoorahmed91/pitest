            ...
            for pin in pins:
                ...
                if current_state != previous_states[pin]:
                    if current_state == False:
                        ...
                        if pin == 27:  # Check if the pressed button is GPIO 27
                            command = 'source /home/taimoor/.bashrc && /home/taimoor/installs/myenv/bin/python /var/www/html/webapp/testpins2.py'
                            subprocess.run(command, shell=True, executable='/bin/bash')  # Run the external script with specified environment
                    else:
                        # Button was released
